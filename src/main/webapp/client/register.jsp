...
<head>
    ...
    <%--导入css和js --%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/webjars/jquery/3.5.0/jquery.js"></script>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/client/css/main.css" type="text/css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/client/js/form.js"></script>
    <script type="text/javascript">
        function findUsername() {
            $.ajax({
                url: "/bookstore/user/findUsername?userName=" + $("#username").val(),
                type: "POST",
        ...
        function findEmail() {
            //  console.log("123456")
            $.ajax({
                url: "/bookstore/user/findEmail?email=" + $("#email").val(),
                type: "POST",
                success: function (data) {
                    if (data == "exist") {
                        alert("邮箱已经被占用");
            ...
            <tr>
                <td style="padding: 30px"><h1>新会员注册</h1>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <h1 style="color:red">${code_error}</h1>
                        </c:otherwise>
                    </c:choose>
