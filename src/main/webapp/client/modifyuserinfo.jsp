                        ...
                        <td>
                            <table width="100%" border="0" cellspacing="2" class="upline">
                                <tr>
                                    ...
                                    <td style="width:40%; padding-left:20px">${sessionScope.login_user.email}</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td style="text-align:right">会员名：</td>
                                    <td style="padding-left:20px">${sessionScope.login_user.username }</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">&nbsp;&nbsp;
                                        <input type="radio" name="radiobutton"
                                               value="radiobutton" ${sessionScope.login_user.gender=='男'?'checked':'' }/> 男
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="radiobutton"
                                               value="radiobutton"  ${sessionScope.login_user.gender=='女'?'checked':'' }/> 女
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align:right">联系方式：</td>
                                    <td colspan="2">
                                        <input name="text2" type="text" value="${sessionScope.login_user.telephone}"
                                               class="textinput"/>
                                    </td>
                                </tr>
                                <tr>
